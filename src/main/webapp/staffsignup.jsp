...
<body onload="loadSelectedOption('defaultRole', 'role', '${signupStaffRole}');
        loadSelectedOption('defaultLocation', 'theatreLocation', '${signupStaffTheatreLocation}');">
    <!-- Navigation bar -->
                            ...
                            <div class="card-body">
                                <form id="signUpForm" action="SignUpStaff" method="POST"
                                    ...
                                    <div class="form-group" id="theatreLocationInput">
                                        ...
                                        <select id="theatreLocation" class="inputbox" name="theatreLocation" form="signUpForm"
